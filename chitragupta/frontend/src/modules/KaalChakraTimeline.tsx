...
const LinearStream = ({ events, selectedId, onSelect }: { events: ForensicEvent[], selectedId: string | null, onSelect: (id: string) => void }) => {
    return (
        <div className="h-full w-80 bg-[#101015]/50 border-r border-[#00D9FF]/20 flex flex-col backdrop-blur-md">
...
export const KaalChakraTimeline = () => {
    ...
    return (
        <div className="flex h-[calc(100vh-60px)] w-full text-white overflow-hidden relative selection:bg-[#00D9FF] selection:text-black">

            {/* LEFT: Linear Stream */}
            <div className="z-10 relative border-r border-[#00D9FF]/20">
                <LinearStream
                    events={events}
            ...
            <div className="w-96 bg-[#101015]/80 border-l border-[#00D9FF]/20 backdrop-blur-xl z-10">
